...
const SECTIONS: { title: string; lines: string[] }[] = [
  ...
  { title: "Cambio", lines: ["Call it at the start of your turn instead of drawing. Everyone else gets one more turn.", "Running out of cards calls it for you.", "After the last turn, you have four seconds to stick before hands are scored. Each correct stick restarts that window."] },
