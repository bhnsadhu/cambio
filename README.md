...
| **Leaving** | During a round, a medium bot takes over the exact seat, card positions, and pending move. Play continues, and a departing host passes hosting to another human. Leaving the lobby or results opens the seat and returns the remaining humans to the lobby. |
